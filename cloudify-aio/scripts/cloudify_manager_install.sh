...
# - VERSION - Cloudify Manager version
...
CM_RPM_URL="https://repository.cloudifysource.org/cloudify/${VERSION}/ga-release/cloudify-manager-install-${VERSION}-ga.el7.x86_64.rpm"
RPM_NAME="cloudify-manager-install-${VERSION}-ga.el7.x86_64.rpm"


curl ${CM_RPM_URL} -o ${RPM_NAME}
sudo yum install -y ${RPM_NAME}
sudo yum install -y openssl python-setuptools python-backports
